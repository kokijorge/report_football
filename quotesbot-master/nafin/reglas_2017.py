...
def build_patterns():
	...
	#2017-2018
		...
		("OCASION", "https://regex101.com/r/85UQmN/4", r"Attempt missed\.\s(.+)\s\(.+?\.(\sAssisted\sby\s)?(?(2)(((?!with|following|from)\w+\s?)+))", (0,3,False) , (2,2,True) ),
		...
		("OCASION MANIFIESTA",  "https://regex101.com/r/JXnV7v/2" ,r"Dangerous play by\s(.+)\s\(.+\." , (0,3,False)),
